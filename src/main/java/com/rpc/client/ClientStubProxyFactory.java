...
public class ClientStubProxyFactory {
	...
	private class ClientStubInvocationHandler implements InvocationHandler {
		...
		public ClientStubInvocationHandler(Class<?> interf,String routeKey) {
			super();
			this.interf = interf;
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			List<ServiceInfo> sinfos=null;
			if(routeKey==null) {
				sinfos = sid.getServiceInfo(serviceName);
			} else {
				sinfos = sid.getServiceInfo(serviceName, routeKey);
			}
