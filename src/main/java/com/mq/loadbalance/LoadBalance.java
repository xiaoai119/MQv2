...
//    }
//
//    public List<BrokerMetaInfo> brokerDiscover(String name) {
//        return zookeeperRoleInfoDiscoverer.getRoleInfo(name, BrokerMetaInfo.class);
//    }
//
//    public HashMap<String, String> loadBlanceByTpoicNames(List<String> topicNames) {
//        HashMap<String, String> result = new HashMap<>();
//        List<BrokerMetaInfo> brokerMetaInfos = brokerDiscover(BrokerService.class.getName());
//
//        for (String topicName : topicNames) {
//            //对于每一个key，首先查找本地的路由表
//            if (routeMap.containsKey(topicName)) {
//                result.put(topicName, routeMap.get(topicName));
//                System.out.println("路由："+topicName+"->"+routeMap.get(topicName));
//            } else {
//                String brokerName = brokerMetaInfos.get(random.nextInt(brokerMetaInfos.size())).getName();
//                result.put(topicName, brokerName);
//                System.out.println("路由："+topicName+"->"+brokerName);
//            }
//        }
//
//        return result;
