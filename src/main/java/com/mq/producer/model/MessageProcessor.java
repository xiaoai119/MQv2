...
public class MessageProcessor {
    ...
    public MessageProcessor(SendQueueManager queueManager, Router router, RPCManager rpcManager) {
        sendRecord = new ConcurrentHashMap<>();
        ackMessage = new CopyOnWriteArrayList<>();
        batchTasks = new CopyOnWriteArrayList<>();
        timeOutQueue = new ArrayBlockingQueue<Message>(10000);
    ...
    public MessageProcessor(SendQueueManager queueManager, Router router, RPCManager rpcManager, Integer batchSize) {
        sendRecord = new ConcurrentHashMap<>();
        ackMessage = new CopyOnWriteArrayList<>();
        batchTasks = new CopyOnWriteArrayList<>();
        timeOutQueue = new ArrayBlockingQueue<Message>(10000);
